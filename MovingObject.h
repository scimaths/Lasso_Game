...
#include <composite.h>
#include <sprite.h>
#define numberOfNumbersTaken 4

using namespace simplecpp;

// Class MovingObject inherited from Sprite
class MovingObject : public Sprite {
    vector<Sprite*> parts;

    double vx, vy;  // Velocity components of Object
    double ax, ay;  // Acceleration components of Object
    bool paused;

    // Initializing the moving object with speed, acceleration.
